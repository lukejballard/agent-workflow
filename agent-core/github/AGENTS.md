...
This is the primary context document for AI agents working in this repository.
...
internally. This package intentionally ships one mind, not a stable of helper
personas.
...
.github/
  ...
  hooks/                       Tool approval hooks and hook runner
